...
export default function PsRecommendation() {
    ...
    // Function to fetch recommendations based on problem statement
    const fetchRecommendations = async () => {
        try {
            ...
            // Get recommendations using the user's ID and the problem statement
            const recRes = await fetch(`http://localhost:5000/api/recommendations/${userData.user._id}`, {
                method: "POST",  // Use POST to send the problem statement
                headers: {
                    "Content-Type": "application/json",
                    Authorization: token,
                },
    ...
    const handleSearch = () => {
        // Trigger fetching of recommendations if problem statement is provided
        ...
        <div className="bg-[#0F172A] text-white min-h-screen">
            ...
            <div className="container mx-auto px-4 py-8">
                ...
                {error ? (
                    ...
                    <div className="text-center py-8">
                        <p>No recommendations found. Please enter a problem statement to get recommendations.</p>
                    </div>
                ) : (
